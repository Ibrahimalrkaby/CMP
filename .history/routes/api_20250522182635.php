...
Route::prefix('attendance')->group(function () {
    Route::post('/{courseId}', [AttendanceController::class, 'store']);             // Add student attendance
    Route::get('/{courseId}', [AttendanceController::class, 'index']);              // Get all attendance for course
    Route::get('/{courseId}/{studentId}', [AttendanceController::class, 'show']);   // Get attendance for student
    Route::put('/{courseId}/{studentId}', [AttendanceController::class, 'update']); // Update student attendance
    Route::delete('/{courseId}/{studentId}', [AttendanceController::class, 'destroy']); // Delete attendance
});
